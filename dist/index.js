...
async function run() {
    try {
        ...
        let slackMessage;
        if (messageType) {
            slackMessage = (0, messages_1.getMessage)({ type: messageType, versionTag, slackChannel });
        }
        else if (message) {
            slackMessage = (0, messages_1.getBaseMessage)(slackChannel, versionTag, message, color);
        }
        else {
...
const getMessage = ({ type, versionTag, slackChannel, }) => {
    ...
    return (0, exports.getBaseMessage)(slackChannel, versionTag, message, color);
};
